...
<html>
  <head>
    ...
    <title>Blueweb Desing| Servicio</title>
	  ...
	  display:block;
              ...
              <?php  
				...
				echo "
					...
					<form action='control/eliminarservicio.php' method='post'>
						<div id='mymodal' class='modal fade in' >
							 <div class='modal-dialog'>
								<div class='modal-content'>
						            <div class='modal-header'>
						                <h3 class='modal-title'>¿Está usted seguro que desea eliminar el servicio: ".$fila['servicio']." ?</h3>
						            </div> 
                          ...
                          <input type='hidden' name='id' value=".$fila['codigo_servicio'].">
											    <button type='submit' type='submit' class='btn btn-success'><i class='fa fa-check'></i> Sí, deseo eliminarlo.</button>
												  <a href='lista-servicios.php'><button type='button' class='btn btn-danger'  value='Abrir'><i class='fa fa-times'></i> NO</button></a>
										    </div>
                        </div> 
