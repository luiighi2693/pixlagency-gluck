...
$uploadDirectory = "/images/sport/";

 
if(isset($_REQUEST['rowid']) and isset($_REQUEST['param'])){
 $rowid = $_REQUEST['rowid'];
 if($rowid>0){
    if($query = mysqli_query($connect,"SELECT * FROM q_sport WHERE rowid = '".$rowid."'")){
      $array=mysqli_fetch_array($query);
      if(isset($_REQUEST["submit"])){
        $name     = $_REQUEST['name'];
        $descriptios    = $_REQUEST['descriptios'];
        $status   = $_REQUEST['status'];
        if($query = mysqli_query($connect,"UPDATE q_sport SET name = '".$name."', descriptios = '".$descriptios."', status = '".$status."' WHERE rowid = '".$rowid."'")){
          ...
          if (empty($errors)) {
            ...
            if ($didUpload) {
               ...
               mysqli_query($connect,"UPDATE q_sport SET img = '".$RandomAccountNumber.'.'.$fileExtension."' WHERE rowid = '".$rowid."'");
            } else {
          ...
          $result = '<div class="callout callout-success">
                      ...
                      header( "refresh:3;url=q_sport_list.php" );
        }else{
    ...
    if($query = mysqli_query($connect,"SELECT * FROM q_sport WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        $descriptios    = $_REQUEST['descriptios'];
        $status   = $_REQUEST['status'];
        if($query = mysqli_query($connect,"INSERT INTO q_sport (name, descriptios, status) VALUES ( '".$name."', '".$descriptios."', '".$status."')")){
          $errors = []; // Store errors here
...
<html>
  <head>
    ...
    <title>Admin | Mantenimiento de Deportes</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Mantenimiento de Deportes
            <small>Vista</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Mantenimiento de Deportes</li>
          </ol>
        </section>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">Foto
                      ...
                      <p class="help-block">
                        ...
                        <img width="250px" src="images/sport/<?=$images;?>" class="img-circle" alt="User Image">
                      </p>
                    </div>
