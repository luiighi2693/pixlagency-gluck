  ...
  <body class="hold-transition skin-black sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
                ...
                ?>
                <a href="quinielas.php" class="small-box-footer bg-grisbox" style="color: #000 !important;">
                <div class="col-lg-3 col-xs-6 sincurva col-md-offset-1">
              <!-- small box -->
              <div class="small-box bg-grisbox" style="; text-align: center;">
                <div class="inner bordesamarillos">
                  <p style="float: right; text-align: right;">+</p>
                  <br>
                  <br>
                  <h4><b>QUINIELAS DISPONIBLES</b></h4> 
                  <br>
                  <br>
                  <?php } ?>
                  <?php
                ...
                ?>
                <a href="quiniela.php" class="small-box-footer bg-grisbox" style="color: #000 !important;">
                <div class="col-lg-3 col-xs-6 sincurva col-md-offset-1">
              <div class="small-box bg-grisbox">
                <div class="inner bordesamarillos">
                	<p style="float: right; text-align: right;">+</p>
                  <br>
                  <br>
                  <h4>QUINIELAS DISPONIBLES</h4> 
                  <br>
                  <br>
                  <?php } ?>
                </div>
            ...
            <?php if ($_SESSION['user']['type']==0) { ?>
              <a href="q_user_list.php" class="small-box-footer bg-grisbox" style="color: #000 !important;">
            <div class="col-lg-3 col-xs-6 sincurva">
              <!-- small box -->
              <div class="small-box bg-grisbox">
                <div class="inner bordesamarillos">
                  <p style="float: right; text-align: right;">+</p>
            ...
            <?php }else{?>
               <a href="q_pools_list_result.php" class="small-box-footer bg-grisbox"  style="color: #000 !important;">
            <div class="col-lg-3 col-xs-6 sincurva">
              <!-- small box -->
              <div class="small-box bg-grisbox">
                <div class="inner bordesamarillos">
            ...
            <div class="col-lg-3 col-xs-6 sincurva">
              <!-- small box -->
              <a href="q_user.php?rowid=<?=$_SESSION['user']['rowid'];?>&param=edit" class="small-box-footer bg-grisbox" style="color: #000 !important;">
              	<div class="small-box bg-grisbox">
                <div class="inner bordesamarillos">
                  <p style="float: right; text-align: right;">+</p>
                  <br>
    ...
    border-radius: 9px; text-align: center;">
          ...
          <div class="row" style="padding-top: 10%;">
                ...
                ?>
            <!-- Left col -->
            <section class="col-lg-9 col-md-offset-1">
              <div class="box box-primary">
                
                <div class="box-body">
                	<img src="images/gluck-ad.png" width="100%" height="10%">
                </div><!-- /.box-body -->
             ...
             <section class="col-lg-9 col-md-offset-1" >
              <div class="box box-primary">
                ...
                <div class="box-body" style="padding-top: 10%; padding-bottom: 10%">
                	<h1 style="text-align: center;"><b>QUINIELAS CALIENTES</b></h1>
                </div><!-- /.box-body -->
