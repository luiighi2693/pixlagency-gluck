      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
                 ...
                 <h1 class="blanco centrado">NOMBRE DE LA QUINIELA</h1>

            <div class="col-lg-10 col-xs-12 sincurva col-md-offset-1" style="background-color: #E9E8E7;">
                
              <!-- small box -->
              <div class="small-box" style="background-color: #E9E8E7; padding-left: 2%;">
                <div class="row">
                 <h2 class="negro">PARTIDO 1</h2>
                 <div class="col-md-3 col-xs-3 blanco" style="float: left;">
                 <img src="images/team/5f6beb61c57ce.png" class="img-circle centrado" width="50%" style="float: left; min-width: 60px;">
                 <br> <br> 
                 <p class="centrado negro" style="float: left;">Nombre del equipo #1</p>
                </div>
                 <div class="col-md-2 col-xs-6 blanco formulario" style="float: left;">
                 <input type="text" class="centrado inputquiniela"  name="">  

                  <h4 class="negro vsquiniela">VS.</h4> 

                  <input type="text" name="" class="centrado inputquiniela"> 
               </div>
                <div class="col-md-3 col-xs-3 blanco" style="float: left;">
                <img src="images/team/5f6beb61c57ce.png" class="img-circle centrado" width="50%" style="float: left; min-width: 60px;">
                <br>  <br> 
                <p class="centrado negro" style="float: left;">Nombre del equipo #2</p>
              </div>

              <div class="col-md-4 col-xs-12 negro centrado bordeformulario" style="float: left;">
                <h4>  Fecha: 9/02/2022</h4>
                <h4> Hora: 2:00 P.M (EST)</h4>
              </div>
              </div>
               </div>
            </div>
          ...
          <hr class="quinielarellenar">
            ...
            <div class="col-lg-10 col-xs-12 sincurva col-md-offset-1" style="background-color: #E9E8E7;">
             ...
             <a class="nav-link buscadores" data-toggle="modal" data-target="#registroquiniela">
          <button type="submit" name="submit" class="centrado registro btn botonregistro" id="submit">REGISTRAR RESULTADOS</button>
        </a>
