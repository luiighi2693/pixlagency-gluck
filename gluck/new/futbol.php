        ...
        <section class="content">
          ...
          <div class="row">
            <?php if ($_SESSION['user']['type']==1) { ?>
               <a href="laliga.php" class="small-box-footer bg-grisbox"  style="color: #000 !important;">
            <div class="col-lg-5 col-xs-6 sincurva col-md-offset-1">
                
                 <h2 class="grisclaro">La Liga</h2>
              <!-- small box -->
              <div class="small-box">
                 <img src="images/la-liga.png" width="80%">
            ...
            <div class="col-lg-5 col-xs-6 sincurva">
                 ...
                 <h2 class="grisclaro">Premier League</h2>
              <!-- small box -->
              <div class="small-box">
                 <img src="images/premier-league.png" width="80%">
            ...
            <div class="col-lg-5 col-xs-6 sincurva col-md-offset-1">
                 ...
                 <h2 class="grisclaro">BundesLiga</h2>
              <!-- small box -->
              <div class="small-box">
                 <img src="images/bundesliga.png" width="80%">
            ...
            <?php if ($_SESSION['user']['type']==1) { ?>
               <a href="#" class="small-box-footer bg-grisbox"  style="color: #000 !important;">
            <div class="col-lg-5 col-xs-6 sincurva">
                 <h2 class="grisclaro">Serie A</h2>
              <!-- small box -->
              <div class="small-box">
                 <img src="images/serie-a.png" width="80%">
            ...
            <?php if ($_SESSION['user']['type']==1) { ?>
               <a href="#" class="small-box-footer bg-grisbox"  style="color: #000 !important;">
            <div class="col-lg-5 col-xs-6 sincurva col-md-offset-1">
                 <h2 class="grisclaro">Ligue 1</h2>
              <!-- small box -->
              <div class="small-box">
                 <img src="images/ligue-1.png" width="80%">
            ...
            <?php if ($_SESSION['user']['type']==1) { ?>
               <a href="#" class="small-box-footer bg-grisbox"  style="color: #000 !important;">
            <div class="col-lg-5 col-xs-6 sincurva">
                 <h2 class="grisclaro">Champions League</h2>
              <!-- small box -->
              <div class="small-box">
                 <img src="images/uefa-champions-league.png" width="80%">
