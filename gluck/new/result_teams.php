            ...
            <div class="row">
                <div class="col-xs-12 table-responsive">
                    <table id="mytable" class="table table-striped">
                        ...
                        <tr>
                            <th>Juego</th>
                            <th colspan="4" style="text-align: center;" class="custom-center-colum">Resultados del
                                Usuario
                            </th>
                            <!--<th class="bg-gray disabled color-palette"></th>
                            <th>Equipo #2</th>
                            <th class="bg-gray disabled color-palette"></th>-->
                            <th colspan="4" style="text-align: center;" class="custom-center-colum">Resultados Finales
                            </th>
                            <!--<th>Equipo #1</th>
...
//                       $sumResFinal=$sumResFinal+$resFinal;
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img width="30px" src="images/team/<?= $images; ?>" class="img-circle"
                                         alt="User Image">
