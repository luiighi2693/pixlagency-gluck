            ...
            <div class="column one column_faq">
                                        <div class="faq">
                                            <div class="mfn-acc faq_wrapper"> <!--  open1st -->
                                                <div class="question">
                                                    <div class="title">
                                                        <span class="num"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></span> <h4><b>QUINIELAS REGISTRADAS</b></h4> 
                                                    </div>
                <div class="answer">
                ...
                <div class="table-responsive">
                    ...
                    <tbody style="margin-top: 65px;">
                      ...
                      <tr>
                        ...
                        <td>
                        	<a href="resultadosquiniela.php" class="nav-link buscadores"><button data-target="entrar">VISUALIZAR</button> </a> </td>
                      </tr>
                      ...
                      ?>
                                                ...
                                                <div class="question">
                                                    <div class="title">
                                                        <span class="num"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></span> <h4> <b>QUINIELAS EN PROCESO</b></h4>
                                                    </div>
                                                    <div class="answer">
                                                        <p>
                                                        </p>
                                                ...
                                                <div class="question">
                                                    <div class="title">
                                                        <span class="num"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></span> <h4> <b>HISTORIAL DE QUINIELAS</b></h4>
                                                    </div>
                                                    <div class="answer">
                                                        <p>
                                                        </p>
