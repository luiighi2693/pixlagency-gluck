      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="image imagenavatar">
              <img src="<?=($_SESSION['user']['img']!='')?'images/clients/'.$_SESSION['user']['img']:'images/clients/avatar5.png';?>" class="img-circle imagenavatar" alt="<?=$_SESSION['user']['name'];?>">
            </div>
            <div class="center info">
              <h4>¡Bienvenido/a <?=$_SESSION['user']['name'];?>!</h4>
            </div>
          </div>
          <!-- search form -->
          ...
          <ul class="sidebar-menu">
           <li class="header"><a href="home.php"><h3 style="text-align: center; font-weight: bold;">MENU</h3></a></li> 
