    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <h1 class="blanco centrado">QUINIELA SEMANAL NOMBRE QUINIELA</h1>

          <H3 class="blanco" style="margin-left: 5%">Usuario: <b>Nombre Usuario</b></H3>

            <div class="col-lg-10 col-xs-12 col-md-offset-1" style="background-color: #FDE206; border-radius: 20px;">

                
              <!-- small box -->
              <div class="small-box" style="background-color: #FDE206; border-radius: 20px;">
                <div class="row">
                 
                <div class="col-md-4 col-xs-4 negro centrado" style="float: left; margin-top: 1%">
                <h4><b>RESULTADOS <br> DEL USUARIO</b></h4>
                  </div>

              <div class="col-md-4 col-xs-4 negro centrado bordeformulario" style="float: left;">
                <h4 style="margin-top: 7%;"><b> RESULTADOS <br> FINALES</b></h4>
              </div>
              <div class="col-md-4 col-xs-4 negro centrado bordeformulario" style="float: left;">
                <h4 style="margin-top: 7%"><b> PUNTACIÓN </b></h4>
              </div>
              </div>
               </div>
            </div>
          ...
          <div class="col-lg-10 col-xs-12 col-md-offset-1">
              ...
              <!-- small box -->
              <div class="small-box" style="border-radius: 20px;">
                <div class="row">
                 
                <div class="col-md-4 col-xs-4 negro centrado" style="float: left; margin-top: 1%; background-color: #FFFFFF !important; border-radius: 40px;">

                <div class="small-box" style="padding-top: 4%;">
                <div class="row">
                 <div class="col-md-4 col-xs-3 blanco" style="float: left;">
                 <img src="images/team/5f6beb61c57ce.png" class="img-circle centrado" width="60%" style="float: left; min-width: 60px; margin-top: 5px;">
                 <br> <br> 
                 <p class="centrado negro" style="float: left;">Real Madrid</p>
                </div>
                 <div class="col-md-3 col-xs-6 blanco formulario" style="float: left;">  
                 	<h4 class="negro" style="float: left;">3</h4>
                  
                  <h4 class="negro" style="float: right;">3</h4>
               </div>
                <div class="col-md-4 col-xs-3 blanco" style="float: left;">
                <img src="images/team/5f6beb61c57ce.png" class="img-circle centrado" width="60%" style="float: left; min-width: 60px; margin-top: 5px;">
                <br>  <br> 
                <p class="centrado negro" style="float: left;">Barcelona</p>
              </div>
              </div>
               </div>
              </div>

              <div class="col-md-4 col-xs-4 negro centrado" style="float: left; margin-top: 1%; background-color: #FFFFFF !important; border-radius: 40px; margin-left: 3px;">
              ...
              <div class="col-md-3 col-xs-4 negro centrado" style="float: left; margin-top: 1%; background-color: #FFFFFF !important; border-radius: 40px; margin-left: 4%;">

                <div class="small-box" style="padding-top: 4%; padding-bottom: 3%;">
