    ...
    if($query = mysqli_query($connect,"SELECT * FROM q_pools WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        if($query_i = mysqli_query($connect,"UPDATE q_pools SET name = '".$name."', fk_sport = '".$fk_sport."', color = '".$color."' , status = '".$status."', quantity = '".$quantity."', penalty = '".$penalty."', puntaje_empate = '".$puntaje_empate."', puntaje_ganar = '".$puntaje_ganar."', puntaje_perder = '".$puntaje_perder."', puntaje_resultado = '".$puntaje_resultado."' WHERE rowid = '".$rowid."'")){
          ...
          mysqli_query($connect,"UPDATE q_pools_details SET penalty = '".$penalty."', label='". $label."', puntaje_empate = '".$puntaje_empate."', puntaje_ganar = '".$puntaje_ganar."', puntaje_perder = '".$puntaje_perder."', puntaje_resultado = '".$puntaje_resultado."' WHERE fk_pools = '".$rowid."'");
    ...
    if($query = mysqli_query($connect,"SELECT * FROM q_pools WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        if($query_i = mysqli_query($connect,"INSERT INTO q_pools (name,fk_sport, quantity, color, status,penalty, puntaje_empate, puntaje_ganar, puntaje_perder, puntaje_resultado) VALUES ( '".$name."', '".$fk_sport."', '".$quantity."', '".$color."' , '".$status."' , '".$penalty."', '".$puntaje_empate."', '".$puntaje_ganar."', '".$puntaje_perder."', '".$puntaje_resultado."')")){
          ...
          for ($i=1; $i <= $quantity; $i++) {
            $label = $_REQUEST['label'.$i]; 
             mysqli_query($connect,"INSERT INTO q_pools_details (fk_pools, status, result, number_pools, result_team_1, result_team_2,penalty, label, puntaje_empate, puntaje_ganar, puntaje_perder, puntaje_resultado) VALUES ( '".$rowid."', '1', 'C','".$i."', '0', '0','".$penalty."','".$label."' , '".$puntaje_empate."', '".$puntaje_ganar."', '".$puntaje_perder."', '".$puntaje_resultado."')");
          }
                      ...
                      <div class="tab-pane" id="puntaje">
                        ...
                        <div class="box-header">
                          ...
                          <div class="box-body table-responsive no-padding">
                            ...
                            <tbody>
                              <tr>
                                <td><input type="text" class="form-control" required="required" name="puntaje_resultado" value="<?=$array['puntaje_resultado'];?>"></td>
                                <td><input type="text" class="form-control" required="required" name="puntaje_ganar" value="<?=$array['puntaje_ganar'];?>"></td>
                                <td><input type="text" class="form-control" required="required" name="puntaje_empate" value="<?=$array['puntaje_empate'];?>"></td>
                                <td><input type="text" class="form-control" required="required" name="puntaje_perder" value="<?=$array['puntaje_perder'];?>"></td>
                              </tr>
                             </tbody>
