                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                          <?php if ($_SESSION['user']['type']==1) { ?>
                              <a href="result_teams.php?rowid=<?=$array['rowid'];?>&name=<?=urlencode($array['name']);?>&param=2"><i title="edit" class="fa fa-fw fa-edit"></i></a>
                          <?php }else{ ?>
                              <a href="q_user_list_result.php?rowid=<?=$array['rowid'];?>&name=<?=urlencode($array['name']);?>&param=2"><i title="edit" class="fa fa-fw fa-edit"></i></a>
                          <?php } ?>
