 ...
 if($rowid>0){
    if($query = mysqli_query($connect,"SELECT * FROM q_user WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        if($query = mysqli_query($connect,"UPDATE q_user SET name = '".$name."', email = '".$email."', phone = '".$phone."', address = '".$address."', state = '".$state."', city = '".$city."', code = '".$code."', fk_sport = '".$fkSport."', status = '".$status."' ".$sql." WHERE rowid = '".$rowid."'")){
    ...
    if($query = mysqli_query($connect,"SELECT * FROM q_user WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        if($query = mysqli_query($connect,"INSERT INTO q_user (name, email, phone, address,state,city,code, fk_sport, status, password) VALUES ( '".$name."', '".$email."', '".$phone."', '".$address."','".$state."','".$city."','".$code."', '".$fkSport."', '".$status."' , '".$password."')")){
          $errors = []; // Store errors here
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" required="required" data-inputmask='"mask": "(9999) 999-9999"' data-mask name="phone" value="<?=$array['phone'];?>">
                      </div>
                    </div>
                    <div class="box">
