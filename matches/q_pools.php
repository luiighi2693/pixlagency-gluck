 ...
 if($rowid>0){
    if($query = mysqli_query($connect,"SELECT * FROM q_pools WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        $name     = $_REQUEST['name'];    
         $quantity.'$quantity';
        if($query_i = mysqli_query($connect,"UPDATE q_pools SET name = '".$name."', fk_sport = '".$fk_sport."', color = '".$color."' , status = '".$status."', quantity = '".$quantity."', penalty = '".$penalty."' WHERE rowid = '".$rowid."'")){

          mysqli_query($connect,"UPDATE q_pools_details SET penalty = '".$penalty."' WHERE fk_pools = '".$rowid."'");
...
//F Finalizado
    ...
    if($query = mysqli_query($connect,"SELECT * FROM q_pools WHERE rowid = '".$rowid."'")){
      ...
      if(isset($_REQUEST["submit"])){
        ...
        $name   = $_REQUEST['name'];
        $penalty = $_REQUEST['penalty'];
        if($query_i = mysqli_query($connect,"INSERT INTO q_pools (name,fk_sport, quantity, color, status,penalty) VALUES ( '".$name."', '".$fk_sport."', '".$quantity."', '".$color."' , '".$status."' , '".$penalty."')")){
          $rowid=mysqli_insert_id($connect);


          for ($i=1; $i <= $quantity; $i++) { 
             mysqli_query($connect,"INSERT INTO q_pools_details (fk_pools, status, result, number_pools, result_team_1, result_team_2,penalty) VALUES ( '".$rowid."', '1', 'C','".$i."', '0', '0','".$penalty."')");
          }
                              ...
                              <div class="col-md-2">
                                <div class="box box-success">
                                  ...
                                  <div class="box-body">
                                    <div class="form-group">
                                        <div class="input-group">
                                        <select class="form-control select2" style="width: 100%;" name="penalty">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <div class="box-body">
                                      ...
                                      <div class="col-md-2"> 
                                        <input type="text" style="border-color: black;" id="result_team_1_penales_<?php echo $array_details['number_pools'];?>" class="form-control" name="result_team_1_penales_<?php echo $array_details['number_pools'];?>" value="" title='Penales'>
                                      </div>
                                    ...
                                    <div class="box-body">
                                      <div class="form-group">  
                                            ...
                                            <select class="form-control select2" name="result_<?php echo $array_details['number_pools'];?>" style="width: 100%;">
                                              ...
                                              <option value="P" <?=($array_details['result']=="P")?'selected="selected"':'';?>>En Proceso</option>
                                              <option value="F" <?=($array_details['result']=="F")?'selected="selected"':'';?>>Finalizado</option>
                                              <option value="E" <?=($array_details['result']=="E")?'selected="selected"':'';?>>Empate</option>
                                              <option value="T" <?=($array_details['result']=="T")?'selected="selected"':'';?>>Penales</option>
